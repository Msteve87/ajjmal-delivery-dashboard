...
return [
    ...
    'local-rate' => [
        'label' => 'سعر التوصيل المحلي',
        'plural_label' => 'سعر التوصيل المحلي',
        'schema' => [
            'id' => 'الرقم',
            'areas' => 'المناطق',
            'home_rate' => 'سعر التوصيل المباشر',
            'locker_rate' =>  'سعر توصيل الى الخزنة',
            'created_at' => 'تاريخ الإنشاء',
        ],
        'columns' => [
            'areas' => 'المناطق',
            'home_rate' => 'سعر التوصيل المباشر',
            'locker_rate' =>  'سعر التوصيل في الخزنة الذكية',
            'created_at' => 'تاريخ الإنشاء',
            'updated_at' => 'تاريخ التحديث',
        ],
        'description' => 'حدد أسعار التوصيل لمناطق محددة بناءً على نوع التوصيل.',
        'config_title' => 'إعدادات التوصيل المحلي',
    ],
];
